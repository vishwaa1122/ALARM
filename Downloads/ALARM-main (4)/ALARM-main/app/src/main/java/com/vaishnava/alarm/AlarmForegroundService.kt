    ...
    class AlarmForegroundService : Service() {
        ...
        override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
            ...
            // Start audio immediately before anything else
            val earlyUri = getEffectiveRingtoneUri()
            startPlayback(earlyUri)
            ...
            if (resumePending) {
                ...
                android.util.Log.d("WakeCheckDebug", "AlarmForegroundService: playback already started early for alarmId=$currentAlarmId isWakeCheckLaunch=$isWakeCheckLaunch")
